...
resource "google_container_cluster" "primary" {
  ...
  enable_intranode_visibility = var.enable_intranode_visibility # Added as part of the checkov checks
  ...
  min_master_version = var.master_version //var.release_channel == null || var.release_channel == "UNSPECIFIED" ? local.master_version : null
