...
variable "users" {
  description = "List of comma-separated user for each key declared in set_users_for."
  type        = list(string)
  default     = []
}

variable "set_users_for" {
  description = "Name of keys for which encrypters and declared  will be set."
  type        = list(string)
  default     = []
}
