...
locals {
  ...
  local_network_peering      = "${var.prefix}-${local.local_network_name}-to-${local.peer_network_name}"
  ...
  peer_network_peering       = "${var.prefix}-${local.peer_network_name}-to-${local.local_network_name}"
